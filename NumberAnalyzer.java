...
public class NumberAnalyzer {
    ...
    /**
     * Prints the numbers starting from 10 and ending at 1
     * in descending order.
     */
    ...
    /**
     * Displays the numbers from 1 to 10 and identifies
     ...
     *
     * @param number the integer whose type needs to be checked
     * @return "Positive", "Negative", or "Zero" according to the number
     */
    ...
    /**
     * Adds two integers together and returns their total.
     *
     * @param number1 the first integer to be added
     * @param number2 the second integer to be added
    ...
    /**
     * Displays the Number Analyzer menu and handles the user's
     * selected operation until the user chooses to exit.
     *
